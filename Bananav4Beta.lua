...
--Mastery
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {Title = "Auto Farm Mastery Fruit", Default = false })
    ToggleMasteryFruit:OnChanged(function(Value)
        AutoFarmMasDevilFruit = Value
    end)
    Options.ToggleMasteryFruit:SetValue(false)

    local ToggleMasteryGun = Tabs.Main:AddToggle("ToggleMasteryGun", {Title = "Auto Farm Mastery Gun", Default = false })
...
local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "Auto Bone[Sea3]", Default = false })
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "Auto Farm Katakuri[Sea3]", Default = false })
...
spawn(function()
    ...
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {Title = "Auto Farm Ectoplasm[Sea2]", Default = false })
...
for _,v in next, workspace.Boats.MarineBrigade:GetDescendants() do
 ...
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
    ...
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Auto Hallow Scythe Fully[Sea3]", Default = false })
	...
	spawn(function()
        ...
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Auto Farm Factory[Sea3]", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Teleport Fruit", Default = false })
...
local ToggleKillAura = Tabs.Raid:AddToggle("ToggleKillAura", {Title = "Auto Kill Aura", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Auto Get Fruit Low Bely", Default = false })
